...
import { mapTicketWriteInput, TicketWriteInput } from './mapper.js';
...
export class GlpiClient {
  ...
  async createTicket(ticket: TicketWriteInput & { name: string; content: string }) {
    return this.createItem('Ticket', mapTicketWriteInput(ticket));
  }

  async updateTicket(id: number, updates: TicketWriteInput) {
    return this.updateItem('Ticket', id, mapTicketWriteInput(updates));
  }
