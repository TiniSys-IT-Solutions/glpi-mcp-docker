...
| Production release | Prepared (`v0.3.4`; `v0.3.3` Docker build failed) | Versioned image workflow, compatibility matrix and release procedure are present; host-level container smoke remains required |
