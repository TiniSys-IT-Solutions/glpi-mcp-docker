...
| Production release | Prepared (`v0.3.3`) | Versioned image workflow, compatibility matrix and release procedure are present; host-level container smoke remains required |
