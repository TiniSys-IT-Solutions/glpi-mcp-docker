...
| `v0.3.0`, `v0.3.1`, `v0.3.2`, `v0.3.3`, `v0.3.4`, `v0.3.5`, `v0.3.6`, `v0.3.7`, `v0.3.8`, ... | Immutable annotated release tags. |
...
copied into the build stage. The corrected release currently prepared is
`v0.3.8`.
...
git commit -m "fix(release): include documentation in Docker build"
git tag -a v0.3.8 -m "Release glpi-mcp-docker v0.3.8"
...
- `0.3.8`, `0.3` and a commit-SHA tag after a push of `v0.3.8`.
